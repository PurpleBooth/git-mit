...
for binary in "${BINARIES[@]}"; do
    ...
    curl -sL "https://codeberg.org/PurpleBooth/git-mit/releases/latest/download/${binary}-${ARCH}" -o "$binary"
    curl -sL "https://codeberg.org/PurpleBooth/git-mit/releases/latest/download/${binary}-${ARCH}.sha256" -o "${binary}.sha256"
